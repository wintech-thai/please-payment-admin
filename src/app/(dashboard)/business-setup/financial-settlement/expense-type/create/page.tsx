...
export default function CreateExpenseTypePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/business-setup/financial-settlement/expense-type${newId ? `?highlight=${newId}` : ''}`)
    } catch (err: unknown) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5 max-w-2xl">
              ...
              <div className="sm:col-span-2">
                ...
                <div
                  ...
                  onClick={() => document.getElementById('expense-create-tag-input')?.focus()}
                >
                  {tags.map(tag => (
