...
export default function UpdatePayInApproveStatusPage() {
  const { t } = useLang()
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5 max-w-2xl">
              ...
              <div className="sm:col-span-2">
                ...
                <div
                  ...
                  onClick={() => document.getElementById('payin-approve-update-tag-input')?.focus()}
                >
                  {tags.map(tag => (
                  ...
                  <input
                    id="payin-approve-update-tag-input"
                    value={tagInput}
