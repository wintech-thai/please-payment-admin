...
export default function CreatePayOutRejectStatusPage() {
  const { t } = useLang()
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5 max-w-2xl">
              ...
              <div className="sm:col-span-2">
                ...
                <div
                  ...
                  onClick={() => document.getElementById('payout-reject-create-tag-input')?.focus()}
                >
                  {tags.map(tag => (
                  ...
                  <input
                    id="payout-reject-create-tag-input"
                    value={tagInput}
