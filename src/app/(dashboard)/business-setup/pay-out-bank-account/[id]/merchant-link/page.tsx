...
import { ChevronLeft, Users, Check, Loader2, Search } from 'lucide-react'
...
export default function PayOutMerchantLinkPage() {
  ...
  return (
    <div className="flex flex-col overflow-hidden h-[calc(100dvh-5rem)] sm:h-[calc(100dvh-6.5rem)]">
      ...
      <div className="flex-none flex items-center gap-3 mb-6">
        <button
          onClick={() => router.push(`/business-setup/pay-out-bank-account?highlight=${id}`)}
      ...
      <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar space-y-5 pb-4">
        ...
        {/* Merchant Section — always Selected level for Pay-Out */}
