        ...
        <div className="flex-1 overflow-y-auto flex flex-col gap-4 pb-2 custom-scrollbar">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 px-7 py-6">
            ...
            <div className="max-w-md">
              <FormField label={m.fieldSourceAccount} required error={errors.payoutBankAccountId}>
                    ...
                    <span className="flex items-center gap-2 min-w-0 flex-1">
                      {selectedTransit ? (
                        ...
                        <span className="text-gray-400">
                          {loadingTransit ? t.admin.loading : m.placeholderSourceAccount}
                        </span>
                      )}
                    </span>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 px-7 py-6">
            ...
            <div className="max-w-md">
              <FormField label={m.fieldDestBankAccount} required error={errors.payinBankAccountId}>
                  ...
                  >
                    <span className="flex items-center gap-2 min-w-0 flex-1">
                      {selectedDest ? (
                        ...
                        <span className="text-gray-400">
                          {loadingDest ? t.admin.loading : m.placeholderDestBankAccount}
                        </span>
                      )}
                    </span>
                    <span className="text-gray-400 text-xs flex-shrink-0">▾</span>
