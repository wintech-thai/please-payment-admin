...
export default function LeaveConfirmModal({ onConfirm, onCancel }: Props) {
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden text-center px-8 py-8" style={{ background: 'linear-gradient(135deg, #b54500 0%, #9a3800 100%)' }}>
        ...
        <p className="text-sm text-white/60 mb-7">You have unsaved changes. Are you sure you want to leave?</p>
