...
ฟีลด์ `BankCode` ที่ใช้ใน `SubmitPayOutRequest` (และตอนตั้งค่าบัญชีธนาคาร) รองรับเฉพาะรหัสย่อชุดนี้เท่านั้น — **ไม่ใช่** รหัส 3 หลักมาตรฐานของธนาคารแห่งประเทศไทย (ธปท.) ตารางด้านล่างเทียบให้ทั้งสองแบบ

> **หมายเหตุ:** สำหรับการโอนออกผ่าน PromptPay ให้ใช้ `QrProvider: PP` แทน ไม่ต้องส่ง `BankCode`
